...
cds.on('served', ()=>{
  ...
  function _html(serviceName, entityName) {
    ...
    const ui5Config = fiori.preview.ui5 || {};
    const theme = ui5Config.theme || {
      light: "sap_fiori_3",
      dark: "sap_fiori_3_dark",
      switch: true
    };
    let ui5Version = ui5Config.version || preview?.fiori?.ui5?.version || '';
    let ui5Host = ui5Config.host || `https://sapui5.hana.ondemand.com/${ui5Version}`;
